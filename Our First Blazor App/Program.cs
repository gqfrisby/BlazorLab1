...
namespace Our_First_Blazor_App
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<IWeeklyForecast, WeeklyForecast>();
            ...
            builder.Services.AddSingleton<IAvailableBooks, AvailableBooks>();
            builder.Services.AddSingleton<IRentedBooks, RentedBooks>();
